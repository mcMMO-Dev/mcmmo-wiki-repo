...
- Vampirism only triggers on a skill if the victim's level is **at least half** the killer's level in that skill, so low-level players cannot be farmed by high-level killers.
