...
Default config files will be generated when you first install the plugin, or if they are missing. To reset a config file back to its default values you can simply delete it, and mcMMO will regenerate it with defaults on the next restart.
